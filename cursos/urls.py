...
from .views import buy_course, CourseMuralDetailView, CoursesView, CourseDetailView, CourseLessonDetailView
...
urlpatterns = [
    ...
    path('<slug:course_slug>/comprar', buy_course, name='comprar-curso'),
